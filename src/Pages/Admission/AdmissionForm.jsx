  ...
  const onSubmit = (data) => {
    ...
    .then(imgResponse=>{
      if(imgResponse.success){
        ...
        const {candidateName,subject,email,phone,address,date_of_birth} = data;
        const appliedCollage = {candidateName,subject,email,phone,address,date_of_birth,collageImage:collage.collegeImage,candidateImage:imgURL,collageName:collage.collegeName ,events:collage.events, sports:collage.sports,researchHistory:collage.researchHistory} ;
        ...
        >
          ...
          <div className="form-control w-full">
            ...
            <input
              type="date"
              placeholder="Phone Number"
              {...register("data_of_birth", { required: true, maxLength: 120 })}
              className="input input-bordered w-full"
            />
          </div>
          </div>
